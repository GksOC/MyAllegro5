...
int main()
{
    ...
    while(1)
    {
        ...
        {
            al_clear_to_color(al_map_rgb(41, 38, 49));

            //al_draw_bitmap(mysha, 0, 0, 0);
            al_draw_tinted_bitmap(mysha, al_map_rgba_f(0.3, 0.0, 0.6, 0.5), 0, 0, 0);

            al_draw_text(font, al_map_rgb(0, 200, 200), 88, 48, 0, "Hello world!");
            ...
            ALLEGRO_VERTEX v[] = {
                ...
                { .x = 330, .y = 320, .z = 0, .color = al_map_rgb_f(1, 0, 0) },
                { .x = 210, .y = 420, .z = 0, .color = al_map_rgb_f(0, 0, 1) },
                { .x = 330, .y = 420, .z = 0, .color = al_map_rgb_f(0, 0, 1) },
            };
